...
function defineRoundTripTestsNamespace() {
    var tests = [];
    var tableName = 'intidroundtriptable';
    ...
    tests.push(createStringIdRoundTripTest('String id - no id on insert, multiple properties', { name: itemName, number: itemNumber, integer: itemInteger, bool: itemBool, date1: zumo.util.randomDate() }));
    for (var t in differentIds) {
        tests.push(createStringIdRoundTripTest('String id - ' + t + ' id on insert, multiple properties', { id: differentIds[t], name: t, number: itemNumber, integer: itemInteger, bool: itemBool, date1: zumo.util.randomDate() }));
    }
