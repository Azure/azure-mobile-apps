...
struct TodoItem: Codable, Identifiable {
    /**
     The unique ID of this item.  This is generally a UUID, but can be anything as long as it is guaranteed to be globally unique across all clients.
     */
    let id: String
    ...
    /**
     Converts this item to a string for logging
     */
