...
namespace push_to_tags
{
    sealed partial class MainPage: Page
    {
        ...
        private IMobileServiceTable<Tags> tagsTable = App.MobileService.GetTable<Tags>();
        ...
        private async Task InsertTag(Tags tag)
        {
            await tagsTable.InsertAsync(tag);
        }
        ...
        {
            var todoItem = new TodoItem { Text = TextInput.Text, Tags = TagsInput.Text };
