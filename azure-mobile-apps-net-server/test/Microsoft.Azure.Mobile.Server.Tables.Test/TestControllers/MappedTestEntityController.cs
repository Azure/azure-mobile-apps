...
{
    public class MappedTestEntityController : TableController<TestEntity>
    {
        protected override void Initialize(HttpControllerContext controllerContext)
        {
            base.Initialize(controllerContext);
            TestEntityModelContext context = new TestEntityModelContext();
            this.DomainManager = new MappedTestEntityDomainManager(context, Request);
