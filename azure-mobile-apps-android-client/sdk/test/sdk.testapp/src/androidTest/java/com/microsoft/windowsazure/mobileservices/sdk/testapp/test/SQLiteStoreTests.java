...
public class SQLiteStoreTests extends InstrumentationTestCase {
    ...
    public void testUpsertForIntPageSize() throws MobileServiceLocalStoreException {
        SQLiteLocalStore store = new SQLiteLocalStore(this.getContext(), TestDbName, null, 1);
        String tableName = "Test999Objects";
        Map<String, ColumnDataType> tableDefinition = new HashMap<String, ColumnDataType>();
        tableDefinition.put("id", ColumnDataType.String);
        ...
        try {
            ...
            int jsonObjectsCount = 999;

            JsonObject[] items = new JsonObject[999];
            ...
            store.upsert(tableName, items, true);

            Query q = QueryOperations.tableName(tableName)
