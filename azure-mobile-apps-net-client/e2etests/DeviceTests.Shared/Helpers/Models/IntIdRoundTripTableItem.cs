...
namespace DeviceTests.Shared.Helpers.Models
{
    ...
    public class IntIdRoundTripTableItem : ICloneableItem<IntIdRoundTripTableItem>
    {
        ...
        public IntIdRoundTripTableItem() { }
        public IntIdRoundTripTableItem(Random rndGen)
        {
        ...
        object ICloneableItem<IntIdRoundTripTableItem>.Id
        {
            get { return this.Id; }
            set { this.Id = (int)value; }
        }

        public IntIdRoundTripTableItem Clone()
        {
            var result = new IntIdRoundTripTableItem
            {
                Id = this.Id,
                Bool = this.Bool,
                Date = this.Date,
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = obj as IntIdRoundTripTableItem;
        ...
        public override string ToString()
        {
            return string.Format(CultureInfo.InvariantCulture,
                "IntIdRoundTripTableItem[Bool={0},Date1={1},Integer={2},Number={3},Name={4}]",
