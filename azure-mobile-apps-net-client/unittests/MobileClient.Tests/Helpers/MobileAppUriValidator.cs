...
namespace MobileClient.Tests.Helpers
{
    ...
    public class MobileAppUriValidator
    {
        ...
        /// </summary>
        public const string DummyMobileAppWithoutTrailingSlash = "http://www.test.com";

        /// <summary>
        /// URI for a dummy mobile app with a folder without trailing slash
        /// </summary>
        public const string DummyMobileAppUriWithFolderWithoutTrailingSlash = "http://www.test.com/testmobileapp";
