...
namespace Microsoft.Datasync.Client.Platforms
{
    ...
    {
        /// <summary>
        /// Default implementation of ApplicationStorage that uses the user-specific and application-specific data store.
        /// </summary>
        internal ApplicationStorage() : this(IsolatedStorageFile.GetUserStoreForApplication()) 
        { 
        }

        /// <summary>
        /// Implementation of the application storage that allows you to specify the storage location.
        /// </summary>
