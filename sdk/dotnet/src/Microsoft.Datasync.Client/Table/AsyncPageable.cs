...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// </summary>
        public HttpResponse<Page<T>> CurrentResponse { get; protected set; }
    ...
    internal class FuncAsyncPageable<T> : AsyncPageable<T> where T : notnull
    {
        ...
        /// </summary>
        private readonly Func<string?, Task<HttpResponse<Page<T>>>> _pageFunc;
        ...
        public FuncAsyncPageable(Func<string?, Task<HttpResponse<Page<T>>>> pageFunc)
        {
            _pageFunc = pageFunc;
        }
        ...
        public override async IAsyncEnumerable<Page<T>> AsPages(string? requestUri = default)
        {
            do
            {
                HttpResponse<Page<T>> pageResponse = await _pageFunc(requestUri).ConfigureAwait(false);
