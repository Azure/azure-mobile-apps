...
internal class MovieApiStartupContractResolver
{
    /// <summary>
    /// Creates a new instance of the <see cref="Startup"/> class
    /// </summary>
    /// <param name="configuration">The application configuration</param>
    public MovieApiStartupContractResolver(IConfiguration configuration)
    {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddDatasyncControllers(new DefaultContractResolver());
    }
