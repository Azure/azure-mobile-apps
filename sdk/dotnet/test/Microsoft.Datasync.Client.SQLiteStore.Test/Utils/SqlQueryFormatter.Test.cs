...
namespace Microsoft.Datasync.Client.SQLiteStore.Test.Utils
{
    ...
    public class SqlQueryFormatter_Tests
    {
        ...
        [InlineData("$filter=releaseDate eq cast(1994-10-14T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] = @p1)", 1, "{\"@p1\":782092800.0}")]
        [InlineData("$filter=releaseDate ge cast(1999-12-31T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] >= @p1)", 1, "{\"@p1\":946598400.0}")]
        [InlineData("$filter=releaseDate gt cast(1999-12-31T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] > @p1)", 1, "{\"@p1\":946598400.0}")]
        [InlineData("$filter=releaseDate le cast(2000-01-01T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] <= @p1)", 1, "{\"@p1\":946684800.0}")]
        [InlineData("$filter=releaseDate lt cast(2000-01-01T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] < @p1)", 1, "{\"@p1\":946684800.0}")]
        ...
        [InlineData("$top=125&$filter=releaseDate eq cast(1994-10-14T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] = @p1) LIMIT 125", 1, "{\"@p1\":782092800.0}")]
        [InlineData("$top=125&$filter=releaseDate ge cast(1999-12-31T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] >= @p1) LIMIT 125", 1, "{\"@p1\":946598400.0}")]
        [InlineData("$top=125&$filter=releaseDate gt cast(1999-12-31T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] > @p1) LIMIT 125", 1, "{\"@p1\":946598400.0}")]
        [InlineData("$top=125&$filter=releaseDate le cast(2000-01-01T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] <= @p1) LIMIT 125", 1, "{\"@p1\":946684800.0}")]
        [InlineData("$top=125&$filter=releaseDate lt cast(2000-01-01T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT * FROM [movies] WHERE ([releaseDate] < @p1) LIMIT 125", 1, "{\"@p1\":946684800.0}")]
        ...
        [InlineData("$filter=hour(updatedAt) gt 12", "SELECT * FROM [movies] WHERE (CAST(strftime('%H', datetime([updatedAt], 'unixepoch')) AS INTEGER) > @p1)", 1, "{\"@p1\":12}")]
        [InlineData("$filter=minute(updatedAt) eq 30", "SELECT * FROM [movies] WHERE (CAST(strftime('%M', datetime([updatedAt], 'unixepoch')) AS INTEGER) = @p1)", 1, "{\"@p1\":30}")]
        [InlineData("$filter=second(updatedAt) ne 0", "SELECT * FROM [movies] WHERE (CAST(strftime('%S', datetime([updatedAt], 'unixepoch')) AS INTEGER) != @p1)", 1, "{\"@p1\":0}")]
        ...
        [InlineData("$filter=bestPictureWinner eq true and ceiling(duration div 60.0) eq 2", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (([bestPictureWinner] = @p1) AND (CEILING(([duration] / @p2)) = @p3))", 3, "{\"@p1\":1,\"@p2\":60.0,\"@p3\":2}")]
        [InlineData("$filter=bestPictureWinner eq true and floor(duration div 60.0) eq 2", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (([bestPictureWinner] = @p1) AND (FLOOR(([duration] / @p2)) = @p3))", 3, "{\"@p1\":1,\"@p2\":60.0,\"@p3\":2}")]
        ...
        [InlineData("$filter=ceiling(duration div 60.0) eq 2", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CEILING(([duration] / @p1)) = @p2)", 2, "{\"@p1\":60.0,\"@p2\":2}")]
        [InlineData("$filter=day(releaseDate) eq 1", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CAST(strftime('%d', datetime([releaseDate], 'unixepoch')) AS INTEGER) = @p1)", 1, "{\"@p1\":1}")]
        ...
        [InlineData("$filter=floor(duration div 60.0) eq 2", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (FLOOR(([duration] / @p1)) = @p2)", 2, "{\"@p1\":60.0,\"@p2\":2}")]
        [InlineData("$filter=month(releaseDate) eq 11", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CAST(strftime('%m', datetime([releaseDate], 'unixepoch')) AS INTEGER) = @p1)", 1, "{\"@p1\":11}")]
        ...
        [InlineData("$filter=releaseDate eq cast(1994-10-14T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT COUNT(1) AS [count] FROM [movies] WHERE ([releaseDate] = @p1)", 1, "{\"@p1\":782092800.0}")]
        [InlineData("$filter=releaseDate ge cast(1999-12-31T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT COUNT(1) AS [count] FROM [movies] WHERE ([releaseDate] >= @p1)", 1, "{\"@p1\":946598400.0}")]
        [InlineData("$filter=releaseDate gt cast(1999-12-31T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT COUNT(1) AS [count] FROM [movies] WHERE ([releaseDate] > @p1)", 1, "{\"@p1\":946598400.0}")]
        [InlineData("$filter=releaseDate le cast(2000-01-01T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT COUNT(1) AS [count] FROM [movies] WHERE ([releaseDate] <= @p1)", 1, "{\"@p1\":946684800.0}")]
        [InlineData("$filter=releaseDate lt cast(2000-01-01T00:00:00.000Z,Edm.DateTimeOffset)", "SELECT COUNT(1) AS [count] FROM [movies] WHERE ([releaseDate] < @p1)", 1, "{\"@p1\":946684800.0}")]
        ...
        [InlineData("$filter=year(releaseDate) eq 1994", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CAST(strftime('%Y', datetime([releaseDate], 'unixepoch')) AS INTEGER) = @p1)", 1, "{\"@p1\":1994}")]
        ...
        [InlineData("$filter=hour(updatedAt) gt 12", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CAST(strftime('%H', datetime([updatedAt], 'unixepoch')) AS INTEGER) > @p1)", 1, "{\"@p1\":12}")]
        [InlineData("$filter=minute(updatedAt) eq 30", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CAST(strftime('%M', datetime([updatedAt], 'unixepoch')) AS INTEGER) = @p1)", 1, "{\"@p1\":30}")]
        [InlineData("$filter=second(updatedAt) ne 0", "SELECT COUNT(1) AS [count] FROM [movies] WHERE (CAST(strftime('%S', datetime([updatedAt], 'unixepoch')) AS INTEGER) != @p1)", 1, "{\"@p1\":0}")]
