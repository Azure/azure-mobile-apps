...
namespace Microsoft.AzureMobile.Server.Test.Authentication
{
    ...
    public class AppServiceToken_Tests
    {
        [Fact]
        public void FromString_Null_Throws()
        {
            ...
            // Act + Assert
            Assert.Throws<ArgumentNullException>(() => AppServiceToken.FromString(token));
        }
        ...
        public void FromString_Empty_Throws()
        {
            ...
            // Act + Assert
            Assert.Throws<ArgumentException>(() => AppServiceToken.FromString(token));
        }
        ...
        public void FromString_PopulatesProvider()
        {
            ...
            // Act
            var actual = AppServiceToken.FromString(token);
