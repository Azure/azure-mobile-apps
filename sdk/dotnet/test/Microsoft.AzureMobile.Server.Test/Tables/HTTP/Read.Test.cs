...
namespace Microsoft.AzureMobile.Server.Test.Tables.HTTP
{
    ...
    public class Read_Tests
    {
        ...
        [InlineData("tables/movies_rated/id-001", HttpStatusCode.Unauthorized)]
        [InlineData("tables/movies_rated/id-001", HttpStatusCode.Unauthorized, "X-Auth", "failed")]
        [InlineData("tables/movies_rated/id-008", HttpStatusCode.NotFound, "X-Auth", "success")]
